...
RUN tar -xvf mailparse-3.0.2.tgz
RUN cd mailparse-3.0.2 && phpize7.2 && ./configure && sed -i 's/#if\s!HAVE_MBSTRING/#ifndef MBFL_MBFILTER_H/' ./mailparse.c && make && mv modules/mailparse.so /usr/lib/php/20170718/
